...
describe("ClassCard", () => {
  ...
  describe("Pro-exclusive Subscriber Count", () => {
    it("shows subscriber count below subscribe button for pro users", () => {
      customRender(
        <ClassCard
          class={mockClosedClass}
          showSubscriptionButton={true}
    ...
    it("shows singular form for 1 subscriber", () => {
      customRender(
        <ClassCard
          class={mockClosedClass}
          showSubscriptionButton={true}
    ...
    it("shows 0 subscribers when watcherCount is 0", () => {
      customRender(
        <ClassCard
          class={mockClosedClass}
          showSubscriptionButton={true}
    ...
    it("does not show subscriber count for non-pro users", () => {
      customRender(
        <ClassCard
          class={mockClosedClass}
          showSubscriptionButton={true}
      ...
      expect(screen.queryByText("5 subscribers")).not.toBeInTheDocument();
    });

    it("does not show subscriber count for plus tier users", () => {
      customRender(
        <ClassCard
          class={mockClosedClass}
          showSubscriptionButton={true}
    ...
    it("does not show subscriber count when watcherCount is undefined", () => {
      customRender(
        <ClassCard
          class={mockClosedClass}
          showSubscriptionButton={true}
